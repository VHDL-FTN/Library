...
void creating_objects_game4 ()
{
    ...
    Xil_Out32(BASEADDR,0x00000069); // Background
    							//53*8-8 is vertical position looking excel document for 4th game
    object_temp = create_object(SQUARE,3,0*64,(53*8-8),200); // 511 is 1 1111 1111
    ...
    object_temp = create_object(SQUARE,3,(3*64),(53*8-8),200);
